...
(function ($) {
	...
	var init = function(plot) {
		...
		var stringFormat = function(content, item, fnct) {
			...
			// yVal match
			if( typeof parseInt(item.series.data[item.dataIndex][1]) === 'number' ) {
				content = adjustValPrecision(yPattern, content, parseInt(item.series.data[item.dataIndex][1]));
			}
