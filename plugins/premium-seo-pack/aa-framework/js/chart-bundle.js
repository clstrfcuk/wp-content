...
var Chart_Color = function (obj) {
	if (obj instanceof Chart_Color) {
		return obj;
	}
	if (!(this instanceof Chart_Color)) {
		return new Chart_Color(obj);
	}
...
Chart_Color.prototype.getValues = function (space) {
	var values = this.values;
	var vals = {};
...
Chart_Color.prototype.setValues = function (space, vals) {
	var values = this.values;
...
Chart_Color.prototype.setSpace = function (space, args) {
	var vals = args[0];
...
Chart_Color.prototype.setChannel = function (space, index, val) {
...
if (typeof window !== 'undefined') {
	window.Chart_Color = Chart_Color;
}

module.exports = Chart_Color;
...
module.exports = function(Chart) {
	...
	helpers.color = !color?
		function(value) {
			console.error('Chart_Color.js not found!');
			return value;
		} :
		function(value) {
