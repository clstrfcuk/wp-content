...
return array(
	...
	//'columns-info-description' => __( 'Choose a layout, click the <strong class="glue">%%icon-nav-elements-solid%% Elements</strong> icon above, then drag elements into a column.', 'cornerstone' ),
	'columns-layout-custom'    => __( 'Custom', 'cornerstone' ),
	//'columns-layout-label'     => __( 'Column Layout &ndash; %%title%%', 'cornerstone' ),
	...
	//'columns-order-label'      => __( 'Column Order &ndash; %%title%%', 'cornerstone' ),
