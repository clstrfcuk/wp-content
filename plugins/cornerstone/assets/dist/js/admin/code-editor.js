...
( function( $ ) {
	...
	$.fn.csCodeEditor = function( options ) {
		...
		var settings, defaults, $textarea, $wrapper, $label;
		...
		$wrapper.addClass( ( 'vertical' === settings.orientation ) ? 'cs-code-editor-vertical' : 'cs-code-editor-horizontal' );
    if ( settings.startOpen ) {
      $wrapper.addClass( 'cs-code-editor-active' );
    }

    $textarea.csCodeEditorInstance = csCodeMirror.fromTextArea( $textarea[0], settings );

		$header = $( defaults.header );
    $header.find('.cs-code-editor-label').text( settings.label );
		$textarea.csCodeEditorInstance.addPanel( $header[0] );
    ...
    // Handle toggling
		$textarea.on( 'csCodeEditor.toggle', function( e, state ) {
			...
			var $blur;
      var current = $wrapper.hasClass( 'cs-code-editor-active' );
      ...
      $textarea.trigger( 'csCodeEditor.toggled', state );
		});
    ...
    $textarea.on( 'csCodeEditor.orient', function( e, state ) {

      var intended = ( 'vertical' === state );
      var current = $wrapper.hasClass('cs-code-editor-vertical');

      if ( current === state ) {
        return;
      }

      $wrapper.removeClass('cs-code-editor-vertical cs-code-editor-horizontal')
        .addClass( intended ? 'cs-code-editor-vertical' : 'cs-code-editor-horizontal');
	...
	$.fn.csCodeEditorToggle = function( state, silent ) {
		if ( invalidEl( this ) ) return this;
    if ( ! silent ) this.trigger( 'csCodeEditor.toggle', state );
		return this;
	};

  $.fn.csCodeEditorOrient = function( state ) {
    if ( invalidEl( this ) ) return this;
    this.trigger( 'csCodeEditor.orient', state );
    return this;
  };

	$.fn.csCodeEditor.defaults = {
		wrapper: '<div class="cs-code-editor-wrapper code-editor"></div>',
		header: '<div class="cs-code-editor-header"><div class="cs-code-editor-label"></div><div class="cs-code-editor-panel"><button class="cs-close"><span class="cs-visually-hidden">Close</span></button><button class="cs-expand"><span class="cs-visually-hidden">Expand</span></button><button class="cs-collapse"><span class="cs-visually-hidden">Collapse</span></button></div></div>',
...
},{"../../lib/codemirror":26}],4:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26}],5:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26}],6:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26,"../fold/xml-fold":12}],7:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26}],8:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26,"../fold/xml-fold":12}],9:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26}],10:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26}],11:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26,"./foldcode":10}],12:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26}],13:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26,"../../mode/css/css":27}],14:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26,"./xml-hint":17}],15:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26}],16:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26}],17:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26}],18:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26}],19:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26}],20:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26}],21:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":26,"../dialog/dialog":3,"./searchcursor":22}],22:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../addon/edit/matchbrackets":7,"../addon/search/searchcursor":22,"../lib/codemirror":26}],26:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
