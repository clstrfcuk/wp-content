...
return array(
  ...
  'about_items' => array(
    ...
    'mc_fields' => array(
      ...
      'content' => __( 'You can add new fields on each list you created with Mailchimp. After selecting a list on <a href="https://admin.mailchimp.com/lists/" target="_blank">MailChimp Lists Page</a> go to "Settings" => "List fields and *|MERGE|* tags". Heads up: "FNAME" and "LNAME" are default and already populated by this plugin.', '__x__' ),
    ),
    'mc_support' => array(
