  ...
  <tr>
    <th>
      <label for="<?php echo $plugin_slug . '_mc_list_cache'; ?>">
        ...
        <span><?php _e( 'If you have added a new email list to your account or a custom field to some list, click the "Refresh" button to see it listed here.', '__x__' ); ?></span>
      </label>
    </th>
    <td>
