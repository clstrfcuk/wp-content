  ...
  function ajax() {
    ...
    if ( is_wp_error( $result ) ) {
      ...
      $message = $result->get_error_message() == 'Member Exists'
               ? __( 'We were unable to add your email to the list: this email is already on the list.', '__x__' )
               : $result->get_error_message(); //__( 'We\'re sorry! Something went wrong. We were unable to add your email to the list. Please try again later.', '__x__' );
