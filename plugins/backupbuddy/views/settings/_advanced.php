...
$settings_form->add_setting( array(
	...
	'tip'		=>		__('[Default: 604800 (weekly)] - By default BackupBuddy will regularly perform an actual test of your PHP maximum memory limit. Many hosts misreport this value or have other global limits in place so it is tested via a real test to confirm.', 'it-l10n-backupbuddy' ),
	'css'		=>		'width: 50px;',
	'after'		=>		' secs. <span class="description"> ' . __( 'Set to zero (0) to disable.', 'it-l10n-backupbuddy' ) . '</span>',
	'rules'		=>		'',
) );
