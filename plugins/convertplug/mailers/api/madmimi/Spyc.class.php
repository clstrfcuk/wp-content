<?php
/**
   * CP_Spyc -- A Simple PHP YAML Class
   * @version 0.4.5
...
if (!function_exists('spyc_load')) {
  ...
  function spyc_load ($string) {
    return CP_Spyc::YAMLLoadString($string);
  }
}
 ...
 */
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = CP_Spyc::YAMLLoad('lucky.yaml');
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
...
define ('CP_SPYC_FROM_COMMAND_LINE', false);

do {
  if (!CP_SPYC_FROM_COMMAND_LINE) break;
