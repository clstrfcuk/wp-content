...
jQuery(document).on("click", "#submit-query", function() {
    ...
    !1;
    var r = "?page=smile-modal-designer&style-view=analytics";
    "" !== t && "" !== a && (r += "&sd=" + t + "&ed=" + a);
    var o = e.join("||");
    r += "&style=" + encodeURIComponent(o) + "&cType=" + l + "&compFactor=" + s, window.history.pushState("/admin.php?page=smile-modal-designer&style-view=analytics", "Connects", r), 
    renderChart();
});
