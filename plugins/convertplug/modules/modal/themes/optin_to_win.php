		  				...
		  				<div class="col-lg-12 form-main <?php echo esc_attr( $formfiled );?> ">
							...
							<?php } ?>
									<form id="smile-optin-form" class="cp-form">
			                			...
			                			<?php if( $a['namefield'] ) { ?>
										<div class="col-lg-6 col-md-6 col-sm-6 col-lg-12 cp-form-name">
							...
							<?php if(!$a['btn_disp_next_line']) {  ?>
								<div class="col-lg-4 col-md-4 col-sm-4 col-lg-12 col-xs-12 cp-submit-btn"> 
							<?php } else { ?>
								<div class="col-lg-12 col-md-12 col-sm-12 col-lg-12 col-xs-12 cp-submit-btn"> 
							<?php } ?> 
	            		<?php } ?>
								
							<button class="cp-submit btn-modal btn btn-subscribe cp_responsive <?php echo esc_attr( $a['btn_style'] ); ?>" type="submit" >
