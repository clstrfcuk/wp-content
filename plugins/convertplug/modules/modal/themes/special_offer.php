	...
	$input_class ='';
		if( !$a['namefield'] ) { 
		 	if($a['btn_disp_next_line']== 0){
		 		...
		 		$input_class ='cp-text-align-left';
		 	}
		 }
          	...
          	<div class="cp-row">
            	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cp-text-container <?php echo esc_attr($imgclass); ?>" >
              		...
              		<div class="cp-short-desc-container cp-clear <?php if( trim( $a['modal_content'] ) == '' ) { echo 'cp-empty'; } ?>">
              			<div class="cp-short-description cp_responsive <?php if( trim( $a['modal_content'] ) == '' ) { echo 'cp-empty'; } ?>" ><?php echo do_shortcode( html_entity_decode(  $a['modal_content'] ) ); ?></div>
             		</div>
             	<div class="cp-form-container <?php echo esc_attr( $form_style ); ?>">
              		<?php if( $a['mailer'] == "custom-form" ) {
						...
						<form id="smile-optin-form" class="cp-form">
                			...
                			<?php if( $a['namefield'] ) { ?>
								<div class="col-lg-12 col-md-12 col-sm-12 col-lg-12 col-xs-12 cp-form-name">
		    	        		...
		    	        		<div class="col-lg-12 col-md-12 col-sm-12 col-lg-12 cp-form-email form-content">
	            			...
	            			<?php } else { ?>
			                		<input class="cp-email <?php echo esc_attr( $input_class ); ?>" type="email" name="email" placeholder="<?php echo $a['placeholder_text']; ?>" required="required" style="<?php echo esc_attr( $input_style ); ?>;margin-right: 15px;" >
						            </form>
							        </div><!-- .form-main -->
							        <?php if($a['btn_disp_next_line'] == 1){ ?>
										<div class="col-lg-12 col-md-12 col-sm-12 col-lg-12 form-button "> 
									 <?php }else{?>
									 	<div class="col-lg-4 col-md-4 col-sm-4 col-lg-12 form-button cp-button-on-same-line"> 
		 							<?php }?>
	            			<?php } ?>    		         
