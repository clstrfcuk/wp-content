...
if( !function_exists( "modal_theme_locked_content" ) ) {
	function modal_theme_locked_content( $atts, $content = null ){
		...
		$form_bg_color = $form_border_color = '';
 ...
 ?>
          	<div class="cp-row">
            	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cp-text-container <?php echo esc_attr($imgclass); ?>" >
             	...
             	<div class="cp-form-container <?php echo esc_attr( $form_class ); ?> <?php echo esc_attr( $form_style ); ?>" style="<?php echo esc_attr( $form_style_css ); ?>">
						...
						<?php if( !$a['namefield'] ) { ?>
							<div class="cp-row">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cp-btn-next">
									<?php }else{ ?>
									<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 cp-btn-same">
								<?php } ?>
						<?php } ?>
						<form id="smile-optin-form" class="cp-form">
	            			...
	            			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-button cp-name-btn" >
	            			<?php } else { ?>
		                		<input class="cp-email " type="email" name="email" placeholder="<?php echo $a['placeholder_text']; ?>" required="required" style="<?php echo esc_attr( $input_style ); ?>;margin-right: 15px;" >
					            </form>
					        </div><!-- .form-main -->
					        <?php if($a['btn_disp_next_line'] == 1){ ?>
							 ...
							 <?php }else{?>
							 	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-button cp-button-on-same-line"> 
 							<?php }?>
	            		<?php } ?>
