  ...
  <div class="wrap-container">
    <div class="bend-heading-section">
      <h1 style="font-size: 38px;" title="<?php echo $_GET['style']; ?>">
        ...
        <span class="cp-strip-text" style="max-width: 260px;top: 10px;"><?php echo esc_attr( $_GET['style'] ); ?></span></h1>
      <h3><a class="add-new-h2" href="?page=smile-modal-designer&style-view=variant&variant-style=<?php echo $_GET['variant-style']; ?>&style=<?php echo sanitize_text_field( $_GET['style'] ); ?>&theme=<?php echo esc_attr( $_GET['theme'] ); ?>" title="<?php _e( "Back to Variant's List", "smile" ); ?>">
