...
<div class="wrap-container">
   <div class="bend-heading-section">
      <h1><?php echo __( "Modal Designer", "smile" ); ?>
    	<a class="add-new-h2" href="?page=smile-modal-designer&style-view=new" title="<?php echo __( "Create New Modal", "smile" ); ?>"><?php echo __( "Create New Modal", "smile" ); ?></a>
        <span class="cp-loader spinner" style="float: none;"></span>
	   </h1>

      <a href="?page=smile-modal-designer&style-view=new" class="bsf-connect-download-csv" style="margin-right: 25px !important;"><i class="connects-icon-square-plus" style="line-height: 30px;font-size: 22px;"></i>
        <?php _e( "Create New Modal", "smile" ); ?>
      </a>
      <a href="?page=smile-modal-designer&style-view=analytics"  style="margin-right: 25px !important;" class="bsf-connect-download-csv"><i class="connects-icon-bar-graph-2" style="line-height: 30px;"></i>
            ...
            <thead>
               <tr>
                 <th scope="col" id="style-name" class="manage-column column-style <?php echo $sortingStyleNameClass; ?>">
                  <a href="?page=smile-modal-designer&orderby=style_name&<?php echo $orderLink; ?>&sq=<?php echo $searchKey; ?>&cont-page=<?php echo $page; ?>">
                 ...
                 <th scope="col" id="impressions" class="manage-column column-impressions <?php echo $sortinglistImpClass; ?>">
                  <a href="?page=smile-modal-designer&orderby=impressions&<?php echo $orderLink; ?>&sq=<?php echo $searchKey; ?>&cont-page=<?php echo $page; ?>">
                  ...
                  <td class="actions column-actions">
                   ...
                   <?php
                    ...
                    <form method="post" class="cp-export-contact" action="<?php echo esc_url($form_action); ?>">
                      ...
                      <a class="action-list cp-download-modal" href="#" target="_top" ><i style="margin-left: 25px;" class="connects-icon-download"></i><span class="action-tooltip"><?php _e( "Export", "smile" ); ?></span></a>
                    </form>
