	...
	class Smile_Modals extends Convert_Plug{
		...
		function load_customizer_scripts(){
			...
			if( isset( $_GET['hidemenubar'] ) && isset( $_GET['module'] ) && $_GET['module'] == "modal" ){
				...
				wp_enqueue_script( 'smile-modal-editor' );
				...
				wp_enqueue_script( 'cp-style-customizer-js', plugins_url( 'assets/demos/'.$_GET['theme'].'/customizer.js', __FILE__ ), "", true );
			}
		}
		...
		function enqueue_front_scripts(){
            ...
            wp_register_script( 'smile-modal-editor', plugins_url( '../assets/js/ckeditor/ckeditor.js', __FILE__), array('smile-customizer-js') );

            if( isset( $_GET['module'] ) && $_GET['module'] == "modal" ) {
            	wp_register_script( 'smile-modal-common', plugins_url( 'assets/js/modal.common.js', __FILE__), array( 'jquery' ), null, true );
            	wp_register_script( 'cp-common-functions-js', plugins_url( 'assets/js/functions-common.js', __FILE__ ), array('smile-modal-common', 'smile-modal-editor'), null, true );
          	}
			...
			if( !isset( $_GET['hidemenubar'] ) ) {
				wp_enqueue_script( 'smile-modal', plugins_url( 'assets/js/modal.min.js', __FILE__), array( 'jquery' ), null, null, true );
			}
