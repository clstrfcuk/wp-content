...
if( !function_exists( "slide_in_theme_optin_widget" ) ) {
	function slide_in_theme_optin_widget( $atts, $content = null ){
		...
		$form_style='';
		if( isset($a['btn_disp_next_line']) && ( $a['btn_disp_next_line'] || $a['namefield'] ) ) {			
		...
		$slidein_head_css .= $a['slidein_id']. ' .cp-optin-widget .cp-slidein-head {border-bottom:'.$a['optin_border_width'].'px solid '.$a['optin_border_color'] .';}';
		  				...
		  				<div class="col-lg-12 form-main <?php echo esc_attr( $formfiled );?> ">
							<?php if( !$a['namefield'] ) { ?>					
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cp-form-email">
										<?php } else { ?>
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cp-form-name">
										<?php } ?>
										<form id="smile-optin-form" class="cp-form">
				                			...
				                			<?php if( $a['namefield'] ) { ?>				                			
						    	        		...
						    	        		<div class="col-lg-12 col-md-12 col-sm-12 col-lg-12 col-xs-12 cp-form-email form-content">
						            		...
						            		<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 col-lg-12 form-button"> 
					            			...
					            			<?php } else { ?>
												...
												<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 col-lg-12 form-button-nxt-line">
					            			<button class="cp-submit btn-slidein btn btn-subscribe <?php echo esc_attr( $a['btn_style'] ); ?>" type="submit">
					            	 			<?php echo do_shortcode( html_entity_decode( stripcslashes( $a['button_title'] ) ) ); ?>
					            			</button>	
			            			</div><!-- .form-button -->
