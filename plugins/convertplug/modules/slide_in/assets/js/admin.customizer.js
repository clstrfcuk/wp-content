jQuery(document).ready(function() {
	...
	//	Also added class '.cp-customizer-slide_in' for this individual module.
	//	Also added class '.cp-THEME_NAME' to provide the theme compatibility 
	jQuery('html').addClass('cp-customizer cp-customizer-slide_in cp-' + cp_active_theme.slug );
...
function cp_append_gfonts(Fonts) {
	jQuery('head').append('<link id="cp-google-fonts" rel="stylesheet" href="http://fonts.googleapis.com/css?family='+Fonts+'" type="text/css" media="all">');
}
function cp_append_to_ckeditor(CKFonts) {
	if( typeof CKFonts != 'undefined' && CKFonts != null && CKFonts != '') {
		//var DefaultFonts = "Arial;Comic Sans MS;Courier New;Georgia;Lucida Sans Unicode;Tahoma;Times New Roman;Trebuchet MS Verdana";
		//CKFonts = CKFonts + DefaultFonts; 
