...
// CKEDITOR.plugins.add( 'cp_font_size', {
//   requires: 'floatpanel,listblock,button',

//   beforeInit: function( editor ) {
//     editor.ui.addHandler( CKEDITOR.UI_CP_FONT_SIZE, CKEDITOR.ui.cp_font_size.handler );
//   }
...
//    *
//    * @readonly
//    * @property {String} [='cp_font_size']
//    * @member CKEDITOR
//    */
//   CKEDITOR.UI_CP_FONT_SIZE = 'cp_font_size';

//   /**
//    * @class
//    * @todo
//    */
//   CKEDITOR.ui.cp_font_size = CKEDITOR.tools.createClass( {
//     $: function( definition ) {
...
//           // Don't change state while cp_font_size is active (#11793).
...
//     /**
//      * Represents cp_font_size handler object.
//      *
//      * @class CKEDITOR.ui.cp_font_size.handler
//      * @singleton
...
//       handler: {
//         /**
//          * Transforms a cp_font_size definition in a {@link CKEDITOR.ui.cp_font_size} instance.
//          *
//          * @param {Object} definition
//          * @returns {CKEDITOR.ui.cp_font_size}
//          */
//         create: function( definition ) {
//           return new CKEDITOR.ui.cp_font_size( definition );
//         }
//       }
//     }
//   } );
...
//    * @todo
//    */
//   CKEDITOR.ui.prototype.addCPFontSize = function( name, definition ) {
//     this.add( name, CKEDITOR.UI_CP_FONT_SIZE, definition );
//   };
...
CKEDITOR.plugins.add( 'cp_font_size', {
  ...
  onLoad: function() {
     ...
     * @todo
     */
    CKEDITOR.ui.cpFontSize = CKEDITOR.tools.createClass( {
      base: CKEDITOR.ui.button,

      /**
       * Creates a cpFontSize class instance.
       *
       * @constructor
       * @param Object definition
       * @todo
      ...
      statics: {
        handler: {
          create: function( definition ) {
            return new CKEDITOR.ui.cpFontSize( definition );
          }
        }
      }
    } );
  ...
  beforeInit: function( editor ) {
    editor.ui.addHandler( CKEDITOR.UI_CP_FONT_SIZE, CKEDITOR.ui.cpFontSize.handler );
  }
} );
