...
if( count($variants) > 0 ) {
  $analyticsLink = "?page=smile-info_bar-designer&style-view=analytics&compFactor=".$compFactor."&style=".urlencode( $styleForAnalytics );
}
  ...
  <div class="wrap-container">
    <div class="bend-heading-section">
      <h1 style="font-size: 38px;">
        ...
        <a class="add-new-h2" href="?page=smile-info_bar-designer&style-view=variant&variant-test=edit&action=new&style_id=<?php echo $variant_style; ?>&variant-style=<?php echo $dynamic_style_name; ?>&style=<?php echo $parent_style; ?>&theme=<?php echo $theme; ?>" title="Add New Variant">
            <?php _e( "Create New Variant", "smile" ); ?>
        </a>
        <a class="add-new-h2" href="?page=smile-info_bar-designer"><?php _e('Back to Info Bar List', 'smile'); ?></a>
      </h1>
      <a href="?page=smile-info_bar-designer&style-view=variant&variant-test=edit&action=new&style_id=<?php echo $variant_style; ?>&variant-style=<?php echo $dynamic_style_name; ?>&style=<?php echo $parent_style; ?>&theme=<?php echo $theme; ?>" title="Create New Variant" class="bsf-connect-download-csv" style="margin-right: 25px !important;"><i class="connects-icon-square-plus" style="line-height: 30px;font-size: 22px;"></i>
        <?php _e( "Create New Variant", "smile" ); ?>
      </a>
      ...
      <a href="?page=smile-info_bar-designer" style="margin-right: 25px !important;" class="bsf-connect-download-csv"><i class="connects-icon-reply" style="line-height: 30px;font-size: 22px;"></i>
                    ...
                    <?php if( !isset($style['multivariant']) ) { ?>
                        <tr id="<?php echo $key; ?>" class="ui-sortable-handle">
                          ...
                          <td class="actions column-actions" style="vertical-align: inherit;">
                            <a class="action-list copy-style-icon" data-style="<?php echo $style_id; ?>" data-variant-style="<?php echo esc_attr( $variant_style ); ?>" data-module="info_bar" data-stylescreen="multivariant" data-option="info_bar_variant_tests" href="#"><i class="connects-icon-paper-stack" style="font-size: 20px;"></i><span class="action-tooltip">
        ...
        if(is_array($variant_tests) && !empty($variant_tests)){
          ...
          ?>
              <tr id="<?php echo $key; ?>" class="ui-sortable-handle">
                ...
                <td class="actions column-actions" style="vertical-align: inherit;">
                  <a class="action-list copy-style-icon" data-style="<?php echo $style_id; ?>" data-variant-style="<?php echo esc_attr( $variant_style ); ?>" data-module="info_bar" data-stylescreen="multivariant" data-option="info_bar_variant_tests" href="#"><i class="connects-icon-paper-stack" style="font-size: 20px;"></i><span class="action-tooltip">
                  <?php _e( "Duplicate Variant", "smile" ); ?>
                  </span></a>
          ...
          ?>
              <tr>
                <th class="cp-list-empty cp-empty-graphic" colspan="4"><?php echo __('FIRST TIME BEING HERE?','smile'); ?><br/><a class="add-new-h2" href="?page=smile-info_bar-designer&style-view=variant&variant-test=edit&action=new&style_id=<?php echo $variant_style; ?>&variant-style=<?php echo $dynamic_style_name; ?>&theme=<?php echo $theme; ?>" title="Create new variant Test">
          ...
          <a class="button-primary cp-add-new-style-bottom" href="?page=smile-info_bar-designer&style-view=variant&variant-test=edit&action=new&style_id=<?php echo $variant_style; ?>&variant-style=<?php echo $dynamic_style_name; ?>&theme=<?php echo $theme; ?>" title="<?php _e( "Create New variant", "smile" ); ?>">
          <?php _e( "Create New Variant", "smile" ); ?>
          </a> </div>
        <!-- smile-stored-styles -->
      </div>
