...
if( !function_exists( "info_bar_theme_free_trial" ) ) {
	function info_bar_theme_free_trial( $atts, $content = null ){
		  		...
		  		<?php } else { ?>
					<div class="cp-flex ib-form-container">
		                ...
		                <div class="cp-button-field">
		                   <button class="cp-button ib-subscribe <?php echo $a['btn_style'];?> cp-submit smile-animated " data-animation="<?php echo esc_attr( $a['button_animation'] ); ?>" style="<?php echo esc_attr( $button_css ); ?>"><?php echo do_shortcode( html_entity_decode( stripcslashes( $a['button_title'] ) ) ); ?></button>
		                </div>
					</div>
				<?php } ?>
				</div> 
