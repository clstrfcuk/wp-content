...
if(!class_exists('AIO_Icon_Manager'))
{
	class AIO_Icon_Manager
	{
		...
		function __construct()
		{
			...
			$this->admin_js 		= plugins_url('../admin/assets/js/',__FILE__);
			$this->admin_css 		= plugins_url('../admin/assets/css/',__FILE__);
		...
		function icon_manager_fonts(){
			wp_enqueue_style('smile-icon-manager-admin',$this->admin_css.'icon-manager.css');
		...
		?>
            ...
            <a href="#smile_upload_icon" class="add-new-h2 smile_upload_icon" data-target="iconfont_upload" data-title="<?php echo __("Upload/Select Fontello Font Zip","ultimate_vc") ?>" data-type="application/octet-stream, application/zip" data-button="<?php echo __("Insert Fonts Zip File","ultimate_vc"); ?>" data-trigger="smile_insert_zip" data-class="media-frame ">
		...
		public function get_font_manager($id = 1)
		{
