        ...
        foreach ( $this->data as $id => $data ) {
            ...
            <script type="text/javascript"><?php ob_start(); do_action( 'soliloquy_api_start_global', $data ); ?>
                ...
                jQuery(document).ready(function($){
                    ...
                    $(document).on('click.soliloquyYouTube<?php echo $data['id']; ?> touchstart.soliloquyYouTube<?php echo $data['id']; ?> touchend.soliloquyYouTube<?php echo $data['id']; ?>', '.soliloquy-youtube-video', function(e){
                        e.preventDefault();
                        var $this  = $(this),
