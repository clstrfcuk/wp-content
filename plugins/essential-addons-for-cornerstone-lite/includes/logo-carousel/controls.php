...
/**
 * Element Controls : Logo Carousel
 */
...
return array(
	...
	'elements' => array(
		'type' => 'sortable',
		'options' => array(
			'element' => 'eacs-logo-carousel-item',
			'newTitle' => __('Carousel Item %s', 'essential-addons-cs'),
			'floor' => 2,
			'capacity' => 100,
			'title_field' => 'heading'
		),
		'context' => 'content',
		'suggest' => array(
			array( 'heading' => __('Carousel Item 1', 'essential-addons-cs') ),
			array( 'heading' => __('Carousel Item 2', 'essential-addons-cs') ),
			array( 'heading' => __('Carousel Item 3', 'essential-addons-cs') ),
			array( 'heading' => __('Carousel Item 4', 'essential-addons-cs') )
		)
	),
