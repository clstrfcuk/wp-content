...
return array(
	...
	'style_preset' => array(
      ...
      'tooltip' => __( 'Select the preset style.', 'essential-addons-cs' ),
		),
		'options' => array(
			'choices' => array(
        array( 'value' => 'none',        'label' => __( 'Simple Style', 'essential-addons-cs' ) ),
        array( 'value' => 'preset_overlay',    'label' => __( 'Overlay Style', 'essential-addons-cs' ) )
      ),
		),
	),
	...
	'slide_spacing' => array(
	 	'type' => 'dimensions',
	 	'ui' => array(
			'title'   => __( 'Spacing between item',  'essential-addons-cs' ),
	...
	'slide_alignment' => array(
		...
		'options' => array(
			...
			'offValue' => '',
			'choices' => array(
				array( 'value' => 'eacs-team-slider-default', 'icon' => fa_entity( 'ban' ),    'tooltip' => __( 'Default', 'cornerstone' ) ),
				array( 'value' => 'eacs-team-slider-left', 'icon' => fa_entity( 'align-left' ),    'tooltip' => __( 'Left', 'cornerstone' ) ),
				array( 'value' => 'eacs-team-slider-centered', 'icon' => fa_entity( 'align-center' ),  'tooltip' => __( 'Center', 'cornerstone' ) ),
				array( 'value' => 'eacs-team-slider-right', 'icon' => fa_entity( 'align-right' ),   'tooltip' => __( 'Right', 'cornerstone' ) )
			)
		)
	),
	...
	'elements' => array(
		'type' => 'sortable',
		'options' => array(
			'element' => 'eacs-team-item',
			'newTitle' => __('Team Member %s', 'essential-addons-cs'),
			'floor' => 2,
			'capacity' => 100,
			'title_field' => 'heading'
		),
		'context' => 'content',
		'suggest' => array(
			array( 'heading' => __('Team Member 1', 'essential-addons-cs') ),
			array( 'heading' => __('Team Member 2', 'essential-addons-cs') ),
			array( 'heading' => __('Team Member 3', 'essential-addons-cs') ),
		)
	),
