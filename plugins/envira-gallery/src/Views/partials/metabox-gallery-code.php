...
<p><?php _e( 'You are also able to use a special shortcode to open a gallery with a link:', 'envira-gallery' ); ?></p>
<div class="envira-code">
	<code id="envira_template_tag_link_<?php echo $data['post']->ID; ?>"><?php echo '[envira-link id="' . $data['post']->ID . '"]Click here[/envira-link]'; ?></code>
	<a href="#" title="<?php _e( 'Copy Template Tag to Clipboard', 'envira-gallery' ); ?>" data-clipboard-target="#envira_template_tag_link_<?php echo $data['post']->ID; ?>" class="dashicons dashicons-clipboard envira-clipboard">
		<span><?php _e( 'Copy to Clipboard', 'envira-gallery' ); ?></span>
	</a>
</div>
