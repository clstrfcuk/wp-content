	...
	*/
	...
	function envira_gallery_sort_gallery(){
		...
		if ( !$direction && isset( $_POST['sort_direction'] ) ) {
			$direction = sanitize_text_field($_POST['sort_direction']);
		}
	...
	function envira_gallery_ajax_dismiss_notice() {
		...
		if ( isset( $_POST['notice'] ) ) {
			...
			$notices = new Notices;
			$notices->dismiss( $_POST['notice'], intval( $_POST['seconds'] ) );
	...
	/**
	 * envira_gallery_get_attachment_links function.
	 *
	 * @access public
	 * @return void
	 */
	...
	/**
	 * envira_gallery_editor_get_galleries function.
	 *
	 * @access public
	 * @return void
	 */
	...
	/**
	 * envira_gallery_move_media function.
	 *
	 * @access public
	 * @return void
	 */
