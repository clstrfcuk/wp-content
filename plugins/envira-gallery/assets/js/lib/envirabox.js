    ...
    $.extend(EnviraBox.prototype, {
        ...
        createGroup : function ( content ) {
            ...
            $.each(items, function( i, item ) {
                ...
                } else if ( Object.keys(obj.opts.caption).length > 0 ) {
                    // used for Envira Links
        ...
        setVideo: function( slide ) {
			...
			if ( slide.opts.arrows !== 0 && slide.opts.arrow_position == 'inside' ){
	            ...
	            slide.$content = $('<div class="envirabox-content" ' + videoWidthHeight + '"><div class="envirabox-navigation-inside"><a data-envirabox-prev title="prev" class="envirabox-arrow envirabox-arrow--left envirabox-nav envirabox-prev" href="#"><span></span></a><a data-envirabox-next title="next" class="envirabox-arrow envirabox-arrow--right envirabox-nav envirabox-next" href="#"><span></span></a></div>')
	                .appendTo( slide.$slide );
			} else {

            // This will be wrapper containing the video
            slide.$content = $('<div class="envirabox-content" ' + videoWidthHeight + '"></div>')
                .appendTo( slide.$slide );
			}
