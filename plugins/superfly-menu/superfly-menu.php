...
global $sf_menu_data;
    ...
    $theme = $options['sf_sidebar_style'] == 'skew' ? $options['sf_skew_type'] : '';
?>
<div class="
        sfm-rollback
        sfm-color1
...
<div id="sfm-sidebar" style="opacity:0" class="sfm-theme-<?php echo $theme; ?> sfm-hl-<?php echo $options['sf_highlight']; if($options['sf_ind'] == 'yes') echo ' sfm-indicators'; if ($options['sf_sidebar_style'] == 'toolbar') echo ' sfm-iconbar'?>">
