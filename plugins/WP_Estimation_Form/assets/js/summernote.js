  ...
  var Renderer = function () {
    ...
    var tplDialogInfo = {
      image: function (lang, options) {
        ...
        var body = '<div class="form-group row note-group-select-from-files" style="display: none;">' +
                     '<label>' + lang.image.selectFromFiles + '</label>' +
                     '<input class="note-image-input form-control" type="file" name="files" accept="image/*" multiple="multiple" />' +
                     imageLimitation +
                   '</div>' +
                   '<div class="form-group row">' +
                     '<label>' + lang.image.url + '</label><br/>' +
                     '<input class="note-image-url form-control col-md-12" type="text" style="width: 400px !important;margin-right: 18px;" />'+
                     '<a class="btn btn-default imageBtn" style=" display: inline-block; margin: 0px;">'+lang.image.selectFromFiles + '</a>' +
                   '</div>';
