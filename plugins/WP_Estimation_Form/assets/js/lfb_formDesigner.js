...
function tld_tdgn_init() {
    ...
    jQuery('.tld_sliderField').change(function () {
        ...
        if (value > jQuery(this).prev('.tld_slider').attr('data-max')) {
            value = jQuery(this).prev('.tld_slider').attr('data-max');
        }
        if (value < jQuery(this).prev('.tld_slider').attr('data-min')) {
            value = jQuery(this).prev('.tld_slider').attr('data-min');
        }
...
function tld_selectElement(element) {    
    ...
    if(jQuery(tld_selectedElement).is('#estimation_popup') ||
        ...
        jQuery('#tdgn-style-visibility').closest('.panel.panel-default').slideDown();        
    }
}
