...
if ($tg_grid_data['source_type'] == 'instagram') {
	...
	if (isset($user_info['content']) && !empty($user_info['content'])) {
		...
		$instagram = '<div class="tg-instagram-user-header">';
			...
			$instagram .= '<div class="tg-instagram-user-desc">';
				$instagram .= '<div class="tg-instagram-user-info">';
					...
					$instagram .= '<a class="tg-instagram-user-follow" rel="nofollow me" target="_blank" href="'.esc_url('https://www.instagram.com/'.sanitize_key($user_info->username)).'/">'.__( 'Follow', 'tg-text-domain' ).'</a>';
				$instagram .= '</div>';
				$instagram .= '<div class="tg-instagram-user-info">';
