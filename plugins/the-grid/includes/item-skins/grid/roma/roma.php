...
$options = array(
	...
	'icons' => array(  // set all icons
		...
		'image'      => '<i class="tg-icon-search2"></i>',  // Ligthbox icon
	...
	'excerpt_length'  => 100,       // Excerpt character length
...
$html .= $content['media_wrapper_start'];
	...
	$html .= '<div class="tg-media-icon">';
		$html .= preg_replace("/<\\/?div(\\s+.*?>|>)/", "", $content['media_button']);
	$html .= '</div>';
	...
	$html .= '</div>';
	$html .= '<div class="tg-item-media-overlay">';
