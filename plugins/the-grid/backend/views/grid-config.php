...
$grid_settings = array(
		...
		'fields' => array(	
			...
			array(
				...
				'sub_desc' =>  '<strong>'.__( '* The grid name must be unique in order to prevent any conflict.', 'tg-text-domain' ).'</strong><span style="display: none" data-grid-name="'.$the_grid_base->get_grid_list_names().'"></span>',
				'type' => 'text',
				'disabled' => false,
				'std' => $grid_name,
				'tab' => __( 'General', 'tg-text-domain' )
			...
			array(
				...
				'sub_desc' =>  '<strong>'.__( '* The grid ID is unique.', 'tg-text-domain' ).'</strong><span style="display: none" data-grid-name="'.$the_grid_base->get_grid_list_names().'"></span>',
				'type' => 'custom',
			...
			array(
				...
				'sub_desc' =>  '<strong>'.__( '* Usefull to add custom css to the grid.', 'tg-text-domain' ).'</strong><span style="display: none" data-grid-name="'.$the_grid_base->get_grid_list_names().'"></span>',
				'type' => 'text',
				'disabled' => false,
				'std' => '',
				'tab' => __( 'General', 'tg-text-domain' ),
			...
			array(
				...
				'desc' => __( 'Will displayed the selected authors for the current grid post', 'tg-text-domain' ),
			...
			array(
				...
				'desc' => __( 'Please add the desired post to be include in the current grid.', 'tg-text-domain' ),
			...
			array( 
				...
				'name' => __('Default Image', 'tg-text-domain'),
				'desc' => __('Add a default image if image is missing (only works with Grid/Justified type).', 'tg-text-domain'),
				'sub_desc' => '',
				'type' => 'image_id',
			...
			array(
				...
				'sub_desc' => '<strong>'.__( '* You also can set the_grid image sizes in', 'tg-text-domain' ).' <a href="'.admin_url( 'admin.php?page=GlobalSettings').'" target="_blank">'.__( 'global settings', 'tg-text-domain' ).'</a>.</strong>',
				'type' => 'select',
