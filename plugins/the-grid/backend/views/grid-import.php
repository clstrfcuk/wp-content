...
$form_import  = '<div class="metabox-holder tg-import">';
	$form_import .= '<div class="postbox">';
		...
		$form_import .= '<div class="inside tg-box-inside">';
			...
			$form_import .= '<br><br><div class="tg-button" data-action="tg_read_import_file" id="tg-import-read-file"><i class="tg-info-box-icon dashicons dashicons-search"></i>'. __( 'Read file', 'tg-text-domain' ) .'</div>';
			$form_import .= ' <span><strong>'. __( 'or', 'tg-text-domain' ) .'&nbsp;&nbsp;</strong></span>';
			$form_import .= '<a class="tg-button" data-action="tg_read_import_file" id="tg-import-read-demo"><i class="dashicons dashicons-search"></i>'.__('Read demo content', 'tg-text-domain').'</a>';
