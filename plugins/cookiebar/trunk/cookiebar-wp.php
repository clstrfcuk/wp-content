...
function force_lang_render()
{
    ...
    <select name='cookiebar_settings[force_lang]'>
        ...
        <option value='cz' <?php selected($options['force_lang'], "cz"); ?>>Czech</option>
        ...
        <option value='se' <?php selected($options['force_lang'], "se"); ?>>Swedish</option>
        <option value='pl' <?php selected($options['force_lang'], "pl"); ?>>Polish</option>
        <option value='po' <?php selected($options['force_lang'], "po"); ?>>Portuguese</option>
        <option value='ro' <?php selected($options['force_lang'], "ro"); ?>>Romanian</option>
        <option value='sk' <?php selected($options['force_lang'], "sk"); ?>>Slovak</option>
        <option value='sl' <?php selected($options['force_lang'], "sl"); ?>>Slovenian</option>
        <option value='sw' <?php selected($options['force_lang'], "sw"); ?>>Swedish</option>
    </select>
    <?php
}
