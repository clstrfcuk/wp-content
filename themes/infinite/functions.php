<?php
	...
	*/
	...
	new gdlr_core_sidebar_generator( array(
		...
		'after_widget'  => '</div>',
		'before_title'  => '<h3 class="infinite-widget-title"><span class="infinite-widget-head-text">',
		'after_title'   => '</span><span class="infinite-widget-head-divider"></span></h3><span class="clear"></span>' ) );
							...
							'title' => array(
								...
								'options' => array(
									...
									'title-background-overlay-opacity' => array(
										...
										'type' => 'text',
										'description' => esc_html__('Fill the number between 0 - 1 ( Leave Blank For Default Value )', 'infinite'),
										'condition' => array( 'title-style' => 'custom' )
									),
									'title-color' => array(
