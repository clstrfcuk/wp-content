(function($){
	...
	var infinite_sticky_navigation = function(){
		...
		this.sticky_nav_logo = this.sticky_nav.find('.infinite-logo-inner img');
		this.logo_height = 35;
				...
				if( !t.sticky_nav.hasClass('infinite-fixed-navigation') ){
					...
					if( $(window).scrollTop() + page_offset > t.sticky_nav.offset().top ){
						...
						if( logo_padding > 0 ){
							...
							t.sticky_nav.addClass('infinite-animate-logo-height');
						}
					...
					if( $(window).scrollTop() + page_offset <= placeholder.offset().top ){
						...
						setTimeout(function(){ t.sticky_nav.removeClass('infinite-animate-fixed-navigation infinite-animate-logo-height'); }, 10);	
						setTimeout(function(){ 
							t.sticky_nav.css('height', ''); 
