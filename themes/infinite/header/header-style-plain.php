...
?>	
<header class="infinite-header-wrap infinite-header-style-plain <?php echo esc_attr($header_wrap_class); ?>" >
			...
			<?php
				...
				if( has_nav_menu('right_menu') || $enable_search || $enable_cart || $enable_right_button ){
					...
					if( $enable_right_button ){
						...
						echo '<a class="infinite-main-menu-right-button" href="' . esc_url($button_link) . '" target="' . esc_attr($button_link_target) . '" >';
