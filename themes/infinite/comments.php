...
<?php 
	...
	if( have_comments() ){
		...
		// comment head
		echo '<div class="infinite-comments-title" >';
	...
	$args = array(
		...
		'title_reply_before' => '<h4 id="reply-title" class="comment-reply-title infinite-content-font">',
		...
		'fields' => apply_filters('comment_form_default_fields', array(
			...
			'url' =>
				...
				'" placeholder="' . esc_attr(esc_html__('Website', 'infinite')) . '" size="30" /><div class="clear"></div></div>'
		)),
