			...
			'layout' => array(
				...
				'options' => array(
					...
					'background-image' => array(
						...
						'type' => 'upload',
						'data-type' => 'file', 
						'selector' => 'body.infinite-boxed.infinite-background-image .infinite-body-background{ background-image: url(#gdlr#); }',
					...
					'background-pattern' => array(
						...
						'data-type' => 'text',
						'options' => 'pattern', 
						'selector' => 'body.infinite-boxed.infinite-background-pattern .infinite-body-outer-wrapper{ background-image: url(' . GDLR_CORE_URL . '/include/images/pattern/#gdlr#.png); }',
			...
			'blog-style' => array(
				...
				'options' => array(
					...
					'blog-max-content-width' => array(
						...
						'data-input-type' => 'pixel',
						'default' => '900px',
						'selector' => 'body.single-post .infinite-sidebar-style-none, body.blog .infinite-sidebar-style-none{ max-width: #gdlr#; }'
					),
			...
			'footer' => array(
				...
				'options' => array(
					...
					'copyright-font-letter-spacing' => array(
						...
						'data-input-type' => 'pixel',
						'default' => '2px',
						'selector' => '.infinite-copyright-container{ letter-spacing: #gdlr#; }',
						'condition' => array( 'enable-copyright' => 'enable' )
					),
					'copyright-text-transform' => array(
						...
						'default' => 'uppercase',
						'selector' => '.infinite-copyright-container{ text-transform: #gdlr#; }',
						'condition' => array( 'enable-copyright' => 'enable' )
					),			
