	...
	$infinite_admin_option->add_element(apply_filters('infinite_color_options',array(
		...
		'options' => array(
			...
			'navigation-menu-color' => array(
				'title' => esc_html__('Menu / Navigation', 'infinite'),
				'options' => array(
			...
			'body-color' => array(
				...
				'options' => array(
					...
					'body-background-color' => array(
						...
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.infinite-body-outer-wrapper, body.infinite-full .infinite-body-wrapper{ background-color: #gdlr#; }'
					),
					...
					'input-box-border-color' => array(
						'title' => esc_html__('Input Box Border Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#d7d7d7',
						'selector' => '.infinite-body input, ' .  
			...
			'single-blog' => array(
				...
				'options' => array(		
					...
					'single-blog-comment-title-color' => array(
						'title' => esc_html__('Single Blog Comment Title', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#464646',
					...
					'single-blog-comment-background-color' => array(
						'title' => esc_html__('Single Blog Comment Background', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#f9f9f9',
			...
			'blog-color' => array(
				...
				'options' => array(
					...
					'blog-frame-background-color' => array(
						...
						'type' => 'colorpicker',
						'default' => '#f9f9f9',
						'selector' => '.gdlr-core-blog-grid-frame, .gdlr-core-blog-full-frame, .gdlr-core-blog-list-frame{ background-color: #gdlr#; }'
					),
					...
					'blog-aside-background-color' => array(
						...
						'selector' => '.infinite-blog-aside-format .infinite-single-article-content, ' . 
							'.gdlr-core-blog-aside-format .gdlr-core-blog-content{ background-color: #gdlr#; }' . 
							'.infinite-blog-quote-format .infinite-single-article-content, ' . 
							'.gdlr-core-blog-quote-format .gdlr-core-blog-content{ background-color: #gdlr#; }'
					),
			...
			'port-color' => array(
				...
				'options' => array(
					...
					'portfolio-frame-background-color' => array(
						...
						'type' => 'colorpicker',
						'default' => '#f5f5f5',
						'selector' => '.gdlr-core-portfolio-grid.gdlr-core-style-with-frame .gdlr-core-portfolio-grid-frame{ background-color: #gdlr#; }'
					),
			...
			'element-4-color' => array(
				'title' => esc_html__('Element P,S,T', 'infinite'),
				'options' => array(
					...
					'slider-control-navigation-color' => array(
						'title' => esc_html__('Slider Control Navigation Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#8a8a8a',
