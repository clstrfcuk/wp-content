...
return array(
	...
	// Layout - Columns
	//'columns-info-title'       => __( 'Want to add content?', '__x__' ),
	//'columns-info-description' => __( 'Choose a layout, click the <strong class="glue">%%icon-nav-elements-solid%% Elements</strong> icon above, then drag elements into a column.', '__x__' ),
	'columns-layout-custom'    => __( 'Custom', '__x__' ),
	//'columns-layout-label'     => __( 'Column Layout &ndash; %%title%%', '__x__' ),
	//'columns-layout-tooltip'   => __( 'Choose from one of our predefined column layouts, or specify your own using the input below. Columns cannot be any smaller than 1/6 and must add up to a whole.', '__x__' ),
	//'columns-order-label'      => __( 'Column Order &ndash; %%title%%', '__x__' ),
	//'columns-order-tooltip'    => __( 'Click and drag to reorder your columns.', '__x__' ),
	'columns-erase-confirm'    => __( 'This will remove all elements from this column. Are you sure you want to continue?', '__x__' ),
