...
return array(
  ...
  'separate-license-needed'  => __( '<strong>NOTE:</strong> A separate license is required for each site using X Pro.', '__x__' ),
  'how-do-i-unlock'          => __( 'Enter your X Pro license into the validation <a %s href="#">field above</a>. If you do not have a license or need to get another, you can <a href="https://theme.co/go/join-validation.php" target="_blank">purchase</a> one.', '__x__' )
);
