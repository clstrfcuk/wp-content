...
// =============================================================================
// FUNCTIONS/BARS/MODULES/_THEMES.PHP
// -----------------------------------------------------------------------------
...
function x_module_theme_button_default() {
  return array(
    'anchor_bg_color'              => x_module_value( 'rgba(255, 255, 255, 0.25)', 'style:color' ),
    'anchor_bg_color_alt'          => x_module_value( 'rgba(255, 255, 255, 0.25)', 'style:color' ),
...
function x_module_theme_cart_button_default() {
  return array(
    ...
    'anchor_primary_text_color'             => x_module_value( 'rgba(0, 0, 0, 0.35)', 'style:color' ),
    'anchor_primary_text_color_alt'         => x_module_value( 'rgba(0, 0, 0, 0.65)', 'style:color' ),
