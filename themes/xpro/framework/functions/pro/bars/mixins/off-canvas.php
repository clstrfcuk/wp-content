...
// =============================================================================
// FUNCTIONS/BARS/MIXINS/OFF-CANVAS.PHP
// -----------------------------------------------------------------------------
// Bar control mixins.
// =============================================================================
...
function x_values_off_canvas( $settings = array() ) {
  ...
  $values = array(
    ...
    'off_canvas_close_color'                   => x_module_value( 'rgba(0, 0, 0, 0.35)', 'style:color' ),
    'off_canvas_close_color_alt'               => x_module_value( 'rgba(0, 0, 0, 0.65)', 'style:color' ),
