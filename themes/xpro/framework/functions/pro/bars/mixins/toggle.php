...
// =============================================================================
// FUNCTIONS/BARS/MIXINS/TOGGLE.PHP
// -----------------------------------------------------------------------------
// Bar control mixins.
// =============================================================================
...
function x_values_toggle( $settings = array() ) {
  ...
  $values = array(
    ...
    $k_pre . 'toggle_color'          => x_module_value( 'rgba(0, 0, 0, 0.35)', 'style:color' ),
    $k_pre . 'toggle_color_alt'      => x_module_value( 'rgba(0, 0, 0, 0.75)', 'style:color' ),
  );
