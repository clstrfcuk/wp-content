...
// =============================================================================
// FUNCTIONS/BARS/MIXINS/CART.PHP
// -----------------------------------------------------------------------------
// Bar control mixins.
// =============================================================================
...
function x_values_cart( $settings = array() ) {
  ...
  $values = array(
    ...
    'cart_title_text_color'                => x_module_value( 'rgba(0, 0, 0, 0.65)', 'style:color' ),
    ...
    'cart_links_text_color'                => x_module_value( 'rgba(0, 0, 0, 0.65)', 'style:color' ),
    'cart_links_text_color_alt'            => x_module_value( 'rgba(0, 0, 0, 0.35)', 'style:color' ),
    ...
    'cart_quantity_text_color'             => x_module_value( 'rgba(0, 0, 0, 0.35)', 'style:color' ),
    ...
    'cart_total_text_color'                => x_module_value( 'rgba(0, 0, 0, 0.65)', 'style:color' ),
