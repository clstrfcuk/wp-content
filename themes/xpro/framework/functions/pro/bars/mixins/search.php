...
// =============================================================================
// FUNCTIONS/BARS/MIXINS/SEARCH.PHP
// -----------------------------------------------------------------------------
// Bar control mixins.
// =============================================================================
...
function x_values_search( $settings = array() ) {
  ...
  $values = array(
    ...
    'search_input_text_color'             => x_module_value( 'rgba(0, 0, 0, 0.25)', 'style:color' ),
    'search_input_text_color_alt'         => x_module_value( 'rgba(0, 0, 0, 0.75)', 'style:color' ),
    ...
    'search_submit_color'                 => x_module_value( 'rgba(0, 0, 0, 0.75)', 'style:color' ),
    'search_submit_color_alt'             => x_module_value( 'rgba(0, 0, 0, 0.75)', 'style:color' ),
