...
function x_values_bg( $settings = array() ) {
  ...
  $values = array(
    ...
    $k_pre . 'bg_lower_image'          => x_module_value( '', 'attr' ),
    $k_pre . 'bg_lower_image_repeat'   => x_module_value( 'no-repeat', 'attr' ),
    $k_pre . 'bg_lower_image_size'     => x_module_value( 'cover', 'attr' ),
    $k_pre . 'bg_lower_image_position' => x_module_value( 'center', 'attr' ),
    $k_pre . 'bg_lower_video'          => x_module_value( '', 'markup' ),
    $k_pre . 'bg_lower_video_poster'   => x_module_value( '', 'markup' ),

    $k_pre . 'bg_upper_type'           => x_module_value( 'none', 'markup' ),
    $k_pre . 'bg_upper_color'          => x_module_value( 'rgba(255, 255, 255, 0.5)', 'attr' ),
    $k_pre . 'bg_upper_image'          => x_module_value( '', 'attr' ),
    $k_pre . 'bg_upper_image_repeat'   => x_module_value( 'no-repeat', 'attr' ),
    $k_pre . 'bg_upper_image_size'     => x_module_value( 'cover', 'attr' ),
    $k_pre . 'bg_upper_image_position' => x_module_value( 'center', 'attr' ),
    $k_pre . 'bg_upper_video'          => x_module_value( '', 'markup' ),
    $k_pre . 'bg_upper_video_poster'   => x_module_value( '', 'markup' ),
