...
function x_bars_element_presets( $presets ) {
  ...
  $stacks  = include( X_TEMPLATE_PATH . '/framework/functions/pro/bars/sample/presets.php' );
...
class X_Generated_Nav_Menu { // 02
  ...
  protected function get_nav_items() {
    ...
    $samples = include( X_TEMPLATE_PATH . '/framework/functions/pro/bars/sample/navigation.php');
