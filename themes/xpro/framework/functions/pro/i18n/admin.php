...
return array(
  ...
  'dashboard-settings-update'   => __( 'Update', '__x__' ),
  'dashboard-settings-info'     => __( 'Once you are satisfied with your settings, click the button below to save them.', '__x__' ),
  'dashboard-settings-updating' => __( 'Updating&hellip;', '__x__' ),
  'dashboard-settings-updated'  => __( 'Settings Saved!', '__x__' ),
  'dashboard-settings-error'    => __( 'Sorry! Unable to Save', '__x__' ),
  ...
  'plugin-update-changelog' => __( 'Visit the <a href="http://theme.co/changelog/#cornerstone">Themeco Changelog</a> for more information.', '__x__' ),
